...
local Window = OrionLib:MakeWindow({IntroText = "DoorsPremium GUI v1.0",Name = "binbinvodoorsPremium", HidePremium = false, SaveConfig = true, ConfigFolder = "DoorsSex"})
...
CreditsTab:AddParagraph("Credits to","OminousVibes - (scripts minh lam scripts de hack nha dang ky kenh nha - minh se lam scripts tren kenh Binbinvogaming nha")

...
local LoadKey = loadstring(game:HttpGet("https://pastebin.com/raw/k8ASTUsQ",true))()
local Window = OrionLib:MakeWindow({Name = "PlaybackxHubreal get key", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
local CurrentKey = ""
...
local Section2 = Tab:AddSection({
	Name = "Get Key - https://workink.net/2L8/GetkeyPlaybackXHub"
})
...
Tab:AddButton({
	Name = "Copy",
	Callback = function()
      		copy("https://workink.net/2L8/GetkeyPlaybackXHub")
